...
[kicad-git-starter](https://github.com/Alex-Hermeling/kicad-git-starter) setup.
...
`https://Alex-Hermeling.github.io/LEDPanel-copy/pr-<number>/`, plus red/green PDFs as a
...
**Schematic** ([PDF](https://github.com/Alex-Hermeling/LEDPanel-copy/raw/previews/schematic/schematic.pdf))

![Schematic](https://github.com/Alex-Hermeling/LEDPanel-copy/raw/previews/schematic/schematic.svg)

**PCB**

| Top | Bottom |
|---|---|
| ![PCB top](https://github.com/Alex-Hermeling/LEDPanel-copy/raw/previews/pcb/pcb-top.png) | ![PCB bottom](https://github.com/Alex-Hermeling/LEDPanel-copy/raw/previews/pcb/pcb-bottom.png) |
